...
>({ data: vacancy }: JobProps<T>) {
  ...
  return (
    <Link to="#">
      <article className="flex h-full min-h-[320px] w-full flex-col rounded-[20px] bg-card p-5 shadow-[0px_4px_0px_0px_rgba(62,73,84,0.04)] transition-shadow duration-200 hover:shadow-[0px_12px_23px_0px_rgba(0,0,0,0.10)] md:p-6 lg:p-7 xl:p-[30px]">
        ...
        <div className="mt-auto flex items-center justify-between gap-6">
          <span className="rounded-[48px] bg-primary-300 px-5 py-[10px] text-base font-medium uppercase text-primary dark:text-slate-200">
            {vacancy.location}
          </span>
