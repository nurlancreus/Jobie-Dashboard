...
export const editProfileSchema = z
  .object({
    ...
    profilePassword: z.string().min(1, "This field is required, make changes"),
    ...
    programming: z.coerce.number().min(1, "This field is required, make changes"),
    prototyping: z.coerce.number().min(1, "This field is required, make changes"),
    uiDesign: z.coerce.number().min(1, "This field is required, make changes"),
    researching: z.coerce.number().min(1, "This field is required, make changes"),
  })
