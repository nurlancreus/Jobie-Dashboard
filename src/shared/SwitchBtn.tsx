  ...
  return (
    <div className="flex items-center gap-5">
      ...
      <label
        role="checkbox"
        htmlFor={id}
        className={`relative h-4 w-8 cursor-pointer rounded-3xl after:absolute after:top-1/2 after:-translate-y-1/2 after:h-4 after:w-4 lg:after:h-5 lg:after:w-5 xl:after:h-6 xl:after:w-6 after:rounded-full after:transition-all after:duration-300 after:content-[''] ${
          switchOn
